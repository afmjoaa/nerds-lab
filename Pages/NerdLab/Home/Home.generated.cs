...
namespace CMS.DocumentEngine.Types.NerdLab
{
	...
	public partial class Home : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "NerdLab.Home";
		...
		public string Title
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Title"), @"Home page title...");
			}
			set
			{
		...
		public string Description
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Description"), @"Home page description...");
			}
			set
			{
		...
		public partial class HomeFields : AbstractHierarchicalObject<HomeFields>
		{
			...
			/// Icon.
			/// </summary>
			public IEnumerable<global::CMS.MediaLibrary.AssetRelatedItem> Icon
			{
				get
				{
					return global::CMS.DataEngine.Internal.JsonDataTypeConverter.ConvertToModels<global::CMS.MediaLibrary.AssetRelatedItem>(mInstance.Icon);
				}
			}
			...
			/// FeatureItem.
			/// </summary>
			public IEnumerable<TreeNode> FeatureItem
			{
				get
				{
					return (mInstance.LinkedContentItems["FeatureItem"]);
				}
			}
		}
